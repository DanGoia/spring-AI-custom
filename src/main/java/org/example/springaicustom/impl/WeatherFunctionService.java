...
import org.example.springaicustom.model.WeatherRequest;
import org.example.springaicustom.model.WeatherResponse;
import org.springframework.web.client.RestClient;

import java.util.function.Function;

public class WeatherFunctionService implements Function<WeatherRequest, WeatherResponse> {
    public static final String WEATHER_URL = "https://api.api-ninjas.com/v1/weather";

    private final String apiNinjasKey;

    public WeatherFunctionService(String apiNinjasKey) {
