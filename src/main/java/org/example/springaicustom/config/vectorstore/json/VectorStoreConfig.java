package org.example.springaicustom.config.vectorstore.json;
...
@Slf4j
@Configuration("SimpleVectorStore")
public class VectorStoreConfig {
    ...
    public SimpleVectorStore simpleVectorStore(EmbeddingModel embeddingModel, VectorStoreProperties vectorStoreProperties) {
        ...
        Path pathToFile = Paths.get(vectorStoreProperties.getVectorStorePath());
